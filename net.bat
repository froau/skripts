...
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Application Name" /t REG_SZ /d "fortniteclient-win64-shipping.exe" /f 
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "DSCP value" /t REG_SZ /d "46" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Local IP" /t REG_SZ /d "*" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Local IP Prefix Length" /t REG_SZ /d "*" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Local Port" /t REG_SZ /d "*" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Protocol" /t REG_SZ /d "UDP" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Remote IP" /t REG_SZ /d "*" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Remote IP Prefix Length" /t REG_SZ /d "*" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "Remote Port" /t REG_SZ /d "*" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "throttle Rate" /t REG_SZ /d "-1" /f
REG ADD "HKEY_LOCAL_MACHINE\SOftWARE\Policies\Microsoft\Windows\QoS\worldoftanks" /v "version" /t REG_SZ /d "1.0" /f
510783
gpupdate /force
